        ...
        with(btn_edit) {
            val filter: ColorFilter? = if (isEdit) {
                PorterDuffColorFilter(
                    ResourcesCompat.getColor(resources, R.color.color_accent, theme),
            ...
            val icon = if (isEdit) {
                ResourcesCompat.getDrawable(resources, R.drawable.ic_save_black_24dp, theme)
            } else {
                ResourcesCompat.getDrawable(resources, R.drawable.ic_edit_black_24dp, theme)
            }
